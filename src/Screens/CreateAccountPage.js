...
export default function CreateAccount({ navigation }) {
  ...
  async function handleSignup() {
    if (email == "" || password == "" || first_name == "" || last_name == "") {
      ...
      if (first_name == "") {
        setPHFName("First Name: Input required !");
        setPHFNameC("red");
      }
      if (last_name == "") {
        setPHLName("Last Name: Input required !");
        setPHLNameC("red");
      }
      if (email == "") {
      ...
      >
        <View style={styles.body}>
          <Image
            resizeMode="cover"
            source={{
              uri: "https://i.pinimg.com/736x/b0/5c/80/b05c80ef1dfc5df58f63086e45267bda.jpg",
            }}
          ...
          <View style={styles.body1}>
            <Image
              resizeMode="cover"
              source={{
                uri: "https://i.pinimg.com/564x/58/c8/51/58c851da1dd0d65cd196de3d3de2916d.jpg",
              }}
